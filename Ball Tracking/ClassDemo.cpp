...
//		}
//		if (contSize) {
//				g_rectBound = boundingRect(contours[g_maxIndex]); // Find the bounding rectangle for biggest contour
...
//				/// Correct for smaller depth window
//				if (isDepth) {
...
//void initTBs() {
//		namedWindow(hue_win);
//		namedWindow(morphROI_win);
//		namedWindow(blur_win);
//		namedWindow(cannyROI_win);
