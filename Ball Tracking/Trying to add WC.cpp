...
//
//bool g_enableRS = true;
//bool g_enableWC = false;
...
//
//				if (g_enableRS) {
//						if (g_smR->AcquireFrame(true) < PXC_STATUS_NO_ERROR) {
//								cout << "Realsense enabled, but not connecting.\n";
//								break;//return?
//						}
//						/// Aquire data
...
//				else if (g_enableWC) {
//						cout << "test1\n";
//						VideoCapture cap(0); // Open detected camera number 0
//						cout << "test2\n";
//						if (!cap.isOpened()) {
//								cout << "test3\n";
//								cout << "Webcam enabled, but not connecting.\n";
//								break; //return?
//						}
//						cout << "test4\n";
//						bool bSuccess = cap.read(frameColorR); // read a new frame from video
//						cout << "test5\n";
...
//								
//								
//				//aveArray[2] = aveArray[1];
//				//aveArray[1] = aveArray[0];
//				//aveArray[0] = frameColorR;
//				//runningAve = 
//				//imshow("Weighted Average", runningAve32F);
//
//
//				/// Manipulate data
//				// Find tennis ball by its Hue
//				if (g_enableColorSegmentation && (g_enableRS || g_enableWC)) {
//
//						//Mat frameC3;
//						Mat frameHSV;
//						//Mat deNoised;	
//
//						// Make HSV version, need to strip the alpha channel first
